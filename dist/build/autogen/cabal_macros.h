...
/* package Dame-0.1.0.0 */
#define VERSION_Dame "0.1.0.0"
#define MIN_VERSION_Dame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Dame-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Dame-0.1.0.0"
